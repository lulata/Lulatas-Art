  ...
  galleryImages.forEach(function(image, index) {
    image.onclick = function() {
      ...
      newImg.onload = function() {
        ...
        newNextBtn.setAttribute("class", "gallery-btn-next");
        ...
        newPrevBtn.setAttribute("class", "gallery-btn-prev");
...
function changeImg(changeDir) {
  ...
  let getImgWindow = document.querySelector(".gallery-window");
  let newImg = document.createElement("img");
  ...
  newImg.onload = function () {
      ...
      let nextBtn = document.querySelector(".gallery-btn-next");
      nextBtn.style.cssText = "right: " + calcImgToEdge + "px;";

      let prevBtn = document.querySelector(".gallery-btn-prev");
